...
export default async function handler(req, res) {
  ...
  try {
    ...
    <head>
      ...
      <style>
        * {
        ...
        .header {
          background: linear-gradient(135deg, #FA57CA 0%, #F4610B 100%);
          color: white;
          padding: 40px 30px;
          text-align: center;
        }
    ...
    <body>
      <div class="email-wrapper">
        ...
        <div class="header">
          ...
          <p>Vous avez reçu un message via votre formulaire de contact depuis les mentions légales</p>
        </div>

        <!-- Content -->
        <div class="content">
          <div class="badge">Message des Mentions Légales</div>
          ...
          <div class="info-grid">
            ...
            <div class="info-item">
              ...
              <div class="info-value">
                <a href="mailto:${escapeHtml(email)}" style="color: #FA57CA; text-decoration: none;">
                  ${escapeHtml(email)}
                </a>
              </div>
            </div>
          ...
          <!-- Call to Action -->
          <div class="divider"></div>
          <div style="background: #eff6ff; border: 1px solid #bfdbfe; padding: 16px; border-radius: 8px; text-align: center; color: #F4610B;">
    ...
    await transporter.sendMail({
      ...
      html: emailHTML,
      text: `Nouveau message depuis les Mentions Légales\n\nNom: ${name}\nEmail: ${email}\n\nSujet choisis: ${subject}\n\nMessage:\n${message.replace(/\n/g, '<br>')}`,
    });
