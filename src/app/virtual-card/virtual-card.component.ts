...
export class VirtualCardComponent {
  ...
  photoUrl = '/jester-cesar.webp';
  qrCodeUrl =
    'https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://linktr.ee/jester_cesar';
  linktreeLogoUrl =
    'https://static.vecteezy.com/system/resources/previews/048/759/320/non_2x/linktree-transparent-icon-free-png.png';
}
